...
> **2026-06-20 현재 라인수: App.tsx 685 · Composer.tsx 953 · SquadView.tsx 280 · main/index.ts 110.**
> §8·§9의 분해 기록에 적힌 라인수(App.tsx 538/471, Composer.tsx 612, SquadView.tsx 436, index.ts 58)는
> 그 시점(2026-06-14)의 스냅샷이며 역사 기록으로 보존한다. 이후 theme(테마 마켓플레이스)·cost·memory 등
> 신규 기능이 추가되며 파일이 다시 자라난 결과가 위 현재 수치다 — 분해의 회귀가 아니라 **기능 증식**이며,
> `max-lines` 래칫(§9)이 이를 가시화하는 본래 역할을 하고 있다.
